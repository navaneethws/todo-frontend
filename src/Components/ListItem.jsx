...
const ListItem = () => {
    ...
    return (
        <div class='list-wrapper flex justify-center items-center flex-col'>
            {
                allLists.map((item) => (
                    <div class="list-container w-full sm:w-2/3 md:w-2/3 lg:w-2/3 xl:w-2/5 flex flex-col sm:flex-row justify-between bg-cyan-800 pt-3 sm:pt-4 pb-3 sm:pb-4 rounded mt-5 sm:mt-10">
